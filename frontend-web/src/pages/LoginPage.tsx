...
import { Mic, User, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[420px] px-6 animate-fade-in">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display text-3xl text-white">欢迎回来</h1>
          <p className="mt-2 text-sm text-white/60">登录你的 HeecoMou 账号</p>
        </div>
